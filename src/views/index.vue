  ...
  <div class="index" :style="note">
    <el-row>
      <el-col
        ...
        :xl="{ span: 16, offset: 4 }"
      >
        <div class="visualization">2023年中国GDP大数据可视图</div>
      </el-col>
    ...
    <el-row>
      <el-col :xs="24" :sm="24" :md="24" :lg="8" :xl="8">
        <el-row>
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <div :style="box">
              <div class="title">
                <i class="el-icon-s-data"></i> 2023年一线城市GDP榜
              </div>
        ...
        <el-row>
          <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
            <div class="loopLeft">
              <div class="title3">
                <i class="el-icon-s-help"></i> GDP增速20强城市
              </div>
              <speed20></speed20>
            </div>
          </el-col>
          <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
            <div class="loopLeft">
              <div class="title3">
                <i class="el-icon-s-help"></i> 珠三角城市群实力图
              </div>
              <zsj></zsj>
            </div>
          </el-col>
        ...
        <el-row>
          <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
            <div class="loopRight">
              <div class="title3">
                <i class="el-icon-s-help"></i> 京津冀城市群实力图
              </div>
              <jjj></jjj>
            </div>
          </el-col>
          <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
            <div class="loopRight">
              <div class="title3">
                <i class="el-icon-s-help"></i> 长三角城市群实力图
              </div>
              <csj></csj>
            </div>
          </el-col>
      ...
      <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="8">
        <div class="animatList">
          <div class="title1">
            <i class="el-icon-s-grid"></i> 2023年城市GDP百强榜
          </div>
      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="16" :xl="16">
        <div class="top10">
          <div class="title2">
            <i class="el-icon-s-marketing"></i> 2023年GDP十强城市
          </div>
          <top10></top10>
        </div>
      </el-col>
  ...
  data() {
    return {
      ...
      box: {
        ...
        borderImage:
          "url(" + require("../assets/img/border.png") + ") 51 32 18 66",
      },
      date: new Date(),
      fullscreen: false,
    };
